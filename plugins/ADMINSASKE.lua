...
return false  end
if tonumber(user) == tonumber(saske) then  
...
if redis:get(saske.."Add:Pin"..msg.chat_id_) then
pin_msg = 'true'
pin = 'ꪜ'
else
pin_msg = 'false'
...
if redis:get(saske.."Add:Kick"..msg.chat_id_) then
Add_Kick = 'true'
kick = 'ꪜ'
else
Add_Kick = 'false'
...
if redis:get(saske.."Add:Info"..msg.chat_id_) then
Add_Info = 'true'
info = 'ꪜ'
else
Add_Info = 'false'
...
if redis:get(saske.."Add:Set:Admin"..msg.chat_id_) then
Add_SetAdmin = 'true'
adde = 'ꪜ'
else
Add_SetAdmin = 'false'
...
if redis:get(saske.."Add:Del"..msg.chat_id_) then
Add_Del = 'true'
del = 'ꪜ'
else
Add_Del = 'false'
...
storm_send(msg.chat_id_,msg.id_,"*📮¦ عذرآ لا تستطيع استخدام هاذا الامر \n👨🏻‍✈️*")   
return false  end 
local Chek_Info = https.request('https://api.telegram.org/bot'..Token..'/getChatMember?chat_id='.. msg.chat_id_ ..'&user_id='.. saske..'')
local Json_Info = JSON.decode(Chek_Info)
if Json_Info.ok == true then
if Json_Info.result.status == "administrator" then
if Json_Info.result.can_change_info == true then
...
storm_send(msg.chat_id_,msg.id_,"*📮¦ عذرآ لا تستطيع استخدام هاذا الامر \n👨🏻‍✈️*")   
return false  end 
redis:set(saske.."Add:Pin"..msg.chat_id_,true)   
...
storm_send(msg.chat_id_,msg.id_,"*📮¦ عذرآ لا تستطيع استخدام هاذا الامر \n👨🏻‍✈️*")   
return false  end 
redis:del(saske.."Add:Pin"..msg.chat_id_)   
...
storm_send(msg.chat_id_,msg.id_,"*📮¦ عذرآ لا تستطيع استخدام هاذا الامر \n👨🏻‍✈️*")   
return false  end 
redis:set(saske.."Add:Del"..msg.chat_id_,true)   
...
storm_send(msg.chat_id_,msg.id_,"*📮¦ عذرآ لا تستطيع استخدام هاذا الامر \n👨🏻‍✈️*")   
return false  end 
redis:del(saske.."Add:Del"..msg.chat_id_)   
...
storm_send(msg.chat_id_,msg.id_,"*📮¦ عذرآ لا تستطيع استخدام هاذا الامر \n👨🏻‍✈️*")   
return false  end 
redis:set(saske.."Add:Set:Admin"..msg.chat_id_,true)   
...
storm_send(msg.chat_id_,msg.id_,"*📮¦ عذرآ لا تستطيع استخدام هاذا الامر \n👨🏻‍✈️*")   
return false  end 
redis:del(saske.."Add:Set:Admin"..msg.chat_id_)   
...
storm_send(msg.chat_id_,msg.id_,"*📮¦ عذرآ لا تستطيع استخدام هاذا الامر \n👨🏻‍✈️*")   
return false  end 
redis:set(saske.."Add:Info"..msg.chat_id_,true)   
...
storm_send(msg.chat_id_,msg.id_,"*📮¦ عذرآ لا تستطيع استخدام هاذا الامر \n👨🏻‍✈️*")   
return false  end 
redis:del(saske.."Add:Info"..msg.chat_id_)   
...
storm_send(msg.chat_id_,msg.id_,"*📮¦ عذرآ لا تستطيع استخدام هاذا الامر \n👨🏻‍✈️*")   
return false  end 
redis:set(saske.."Add:Kick"..msg.chat_id_,true)   
...
storm_send(msg.chat_id_,msg.id_,"*📮¦ عذرآ لا تستطيع استخدام هاذا الامر \n👨🏻‍✈️*")   
return false  end 
redis:del(saske.."Add:Kick"..msg.chat_id_)   

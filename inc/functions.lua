...
is_JoinChannel = function(msg)
	local var = true
	channel = (redis:get(AVIRA.."Force_ChaNNeL") or "lII1l")
...
----------------------{ Get Name Bot }-----------------------------
Bot_Name = redis:get(AVIRA..":NameBot:")
...
var = 'مطور اساسي 👨🏻‍✈️' 
elseif redis:sismember(AVIRA..':SUDO_BOT:',UserID) then
var = 'مطور البوت 👨🏽‍💻' 
elseif redis:sismember(AVIRA..':MONSHA_BOT:'..ChatID,UserID) then
var = ' المنشىء 👷🏽' 
elseif redis:sismember(AVIRA..'owners:'..ChatID,UserID) then
var = 'مدير البوت 👨🏼‍⚕️' 
elseif redis:sismember(AVIRA..'admins:'..ChatID,UserID) then
var = 'ادمن في البوت 👨🏼‍🎓' 
elseif redis:sismember(AVIRA..'whitelist:'..ChatID,UserID) then
var = 'عضو مميز ⭐️' 
else
var = 'فقط عضو 🙍🏼‍♂️' 
end
...
if msg.edited then
redis:incr(AVIRA..':edited:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.text and not msg.forward_info then
redis:incr(AVIRA..'msgs:'..msg.sender_user_id_..':'..msg.chat_id_)
elseif msg.adduser then 
redis:incr(AVIRA..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.photo then
redis:incr(AVIRA..':photo:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.sticker then
redis:incr(AVIRA..':sticker:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.voice then
redis:incr(AVIRA..':voice:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.audio then
redis:incr(AVIRA..':audio:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.video or msg.video_note then
redis:incr(AVIRA..':video:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.animation then
redis:incr(AVIRA..':animation:'..msg.chat_id_..':'..msg.sender_user_id_)
end
end
...
local list = redis:smembers(AVIRA..':SUDO_BOT:')
message = '👨🏽‍💻*¦* قائمه الـمـطـوريـن : \n\n`★`*_* '..SUDO_USER..' ➣ (' ..SUDO_ID.. '){'..redis:scard(AVIRA..'mtwr_count'..SUDO_ID)..'}\n*----------------------------------*\n'
if #list==0 then  message = message.."* لا يوجد مطورين حاليا \n📛 *"
else
for k,v in pairs(list) do
local info = redis:hgetall(AVIRA..'username:'..v)
local count = redis:scard(AVIRA..'mtwr_count'..v)
...
local monsha = redis:smembers(AVIRA..':MONSHA_BOT:'..msg.chat_id_)
if #monsha == 0 then 
...
message = message..'*----------------------------------\n\n📋¦ قائمه المدراء :*\n\n'
local list = redis:smembers(AVIRA..'owners:'..msg.chat_id_)
if #list == 0 then  
...
local list = redis:smembers(AVIRA..'admins:'..msg.chat_id_)
...
local list = redis:smembers(AVIRA..'whitelist:'..msg.chat_id_)
...
if redis:sismember(AVIRA..'is_silent_users:'..Group,User) then 
return true 
else
return false
end 
...
local list = redis:smembers(AVIRA..'is_silent_users:'..msg.chat_id_)
...
if redis:sismember(AVIRA..'banned:'..Group,User) then 
return true 
else
return false
end 
...
if redis:sismember(AVIRA..'gban_users',User) then 
return true 
else
return false
end 
...
local list = redis:smembers(AVIRA..'gban_users')
...
local list = redis:smembers(AVIRA..':Filter_Word:'..msg.chat_id_)
if #list ~=0 then
...
if redis:sismember(AVIRA..':Filter_Word:'..msg.chat_id_,word) then 
return  "📝*¦* الكلمه *{"..word.."}* هي بالتأكيد من قائمه المنع✓️" 
else
redis:sadd(AVIRA..':Filter_Word:'..msg.chat_id_,word) 
...
if redis:sismember(AVIRA..':Filter_Word:'..msg.chat_id_,word) then 
redis:srem(AVIRA..':Filter_Word:'..msg.chat_id_,word) 
...
EnterCmd = true
local NumberFlood = tonumber(redis:get(AVIRA..':Flood_Spam:'..msg.sender_user_id_..':msgs') or 0)
if NumberFlood > 3 then 
redis:setex(AVIRA..':Flood_Spam:'..msg.sender_user_id_..':Stoped',10,true)
EnterCmd = false
elseif redis:get(AVIRA..':Flood_Spam:'..msg.sender_user_id_..':Stoped') then
EnterCmd = false
else
redis:setex(AVIRA..':Flood_Spam:'..msg.sender_user_id_..':msgs',3,NumberFlood+1)
end
return EnterCmd
end
...
json_data = '{"BotID": '..AVIRA..',"UserBot": "'..Bot_User..'","Groups" : {'
local All_Groups_ID = redis:smembers(AVIRA..'group:ids')
for key,GroupS in pairs(All_Groups_ID) do
local NameGroup = (redis:get(AVIRA..'group:name'..GroupS) or '')
...
local admins = redis:smembers(AVIRA..'admins:'..GroupS)
if #admins ~= 0 then
json_data =  json_data..',"Admins" : {'
for key,value in pairs(admins) do
local info = redis:hgetall(AVIRA..'username:'..value)
if info then 
...
local creator = redis:smembers(AVIRA..':MONSHA_BOT:'..GroupS)
if #creator ~= 0 then
...
local owner = redis:smembers(AVIRA..'owners:'..GroupS)
if #owner ~= 0 then
...
local list = redis:smembers(AVIRA..'group:ids')
message = '📋*¦* قائمه المجموعات :\n\n'
for k,v in pairs(list) do 
local info = redis:get(AVIRA..'group:name'..v)
if info then 
...
redis:del(
AVIRA..'group:add'..id_group,
AVIRA..'lock_link'..id_group, 
AVIRA..'lock_id'..id_group,
AVIRA..'lock_spam'..id_group, 
AVIRA..'lock_webpage'..id_group,
AVIRA..'lock_markdown'..id_group,
AVIRA..'lock_flood'..id_group,
AVIRA..'lock_bots'..id_group,
AVIRA..'mute_forward'..id_group,
AVIRA..'mute_contact'..id_group,
AVIRA..'mute_location'..id_group,
AVIRA..'mute_document'..id_group,
AVIRA..'mute_keyboard'..id_group,
AVIRA..'mute_game'..id_group,
AVIRA..'mute_inline'..id_group,
AVIRA..'lock_username'..id_group,
AVIRA..'num_msg_max'..id_group,
AVIRA..'replay'..id_group
)
redis:srem(AVIRA..'group:ids',id_group)
end
...
redis:hset(AVIRA..'username:'..data.id_,'username',ResolveUser(data))
redis:sadd(AVIRA..'admins:'..msg.chat_id_,data.id_)
end,nil)
end
end
if NumAdmin == 0 then 
...
if redis:get(AVIRA..'group:add'..msg.chat_id_) then  return '🎗*¦* المجموعه بالتأكيد ✓️ تم تفعيلها' end
...
redis:setex(AVIRA..":ismember:"..msg.sender_user_id_,1500,true)
GetFullChat(msg.chat_id_,function(arg,data) 
local GroupUsers = tonumber(redis:get(AVIRA..':addnumberusers') or 0)
...
local lock_service = redis:get(AVIRA..'lock_service')
...
GetUserID(v.user_id_,function(arg,data)
redis:hset(AVIRA..'username:'..data.id_, 'username', ResolveUser(data))
redis:sadd(AVIRA..':MONSHA_BOT:'..msg.chat_id_,data.id_)
end)
...
redis:mset(
AVIRA..'group:add'..msg.chat_id_,true,
AVIRA..'lock_link'..msg.chat_id_,true, 
AVIRA..'lock_id'..msg.chat_id_,true,
AVIRA..'lock_spam'..msg.chat_id_,true,
AVIRA..'lock_webpage'..msg.chat_id_,true,
AVIRA..'lock_markdown'..msg.chat_id_,true,
AVIRA..'lock_flood'..msg.chat_id_,true,
...
AVIRA..'mute_keyboard'..msg.chat_id_,true,
AVIRA..'mute_game'..msg.chat_id_,true,
AVIRA..'mute_inline'..msg.chat_id_,true,
AVIRA..'lock_username'..msg.chat_id_,true,
AVIRA..'num_msg_max'..msg.chat_id_,5, 
AVIRA..'replay'..msg.chat_id_,true
)

redis:sadd(AVIRA..'group:ids',msg.chat_id_) 
redis:sadd(AVIRA..'mtwr_count'..msg.sender_user_id_,msg.chat_id_)

GroupTitle(msg.chat_id_,function(arg,data)
local NameGroup = data.title_
redis:set(AVIRA..'group:name'..msg.chat_id_,NameGroup)
...
redis:set(AVIRA..'linkGroup'..msg.chat_id_,Gp_Link)
...
if not redis:get(AVIRA..'group:add'..msg.chat_id_) then return '🛠*¦* المجموعه بالتأكيد ✓️ تم تعطيلها' end  
...
if redis:sismember(AVIRA..':MONSHA_BOT:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'👤¦ العضو » '..USERNAME..' \n🎫¦ الايدي » {'..UserID..'}\n🛠¦ انه بالتأكيد منشىء  \n✓️',12,USERCAR) 
end
redis:hset(AVIRA..'username:'..UserID,'username',Resolv)
redis:sadd(AVIRA..':MONSHA_BOT:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'👤¦ العضو » '..USERNAME..' \n🎫¦ الايدي » {'..UserID..'}\n🛠¦ تمت ترقيته ليصبح منشىء في البوت \n✓️',12,USERCAR) 
end

if cmd == "remmnsha" then
if not redis:sismember(AVIRA..':MONSHA_BOT:'..ChatID,UserID) then
return SendMention(ChatID,UserID,MsgID,'👤¦ العضو » '..USERNAME..' \n🎫¦ الايدي » {'..UserID..'}\n🛠¦ انه بالتأكيد ليس منشىء \n✓️',12,USERCAR) 
end
redis:srem(AVIRA..':MONSHA_BOT:'..ChatID,UserID)
...
if redis:sismember(AVIRA..'whitelist:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'👤¦ العضو » '..USERNAME..' \n🎫¦ الايدي » {'..UserID..'}\n🛠¦ انه بالتأكيد عضو مميز \n✓️',12,USERCAR) 
end
redis:hset(AVIRA..'username:'..UserID, 'username', Resolv)
redis:sadd(AVIRA..'whitelist:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'👤¦ العضو » '..USERNAME..' \n🎫¦ الايدي » {'..UserID..'}\n🛠¦ تمت ترقيته ليصبح عضو مميز \n✓️',12,USERCAR) 
end

if cmd == "remwhitelist" then
if not redis:sismember(AVIRA..'whitelist:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'👤¦ العضو » '..USERNAME..' \n🎫¦ الايدي » {'..UserID..'}\n🛠¦ انه بالتأكيد ليس عضو مميز \n✓️',12,USERCAR) 
end
redis:srem(AVIRA..'whitelist:'..ChatID,UserID)
...
if redis:sismember(AVIRA..'owners:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'👤¦ العضو » '..USERNAME..' \n🎫¦ الايدي » {'..UserID..'}\n🛠¦ انه بالتأكيد مدير \n✓️',12,USERCAR) 
end
redis:hset(AVIRA..'username:'..UserID, 'username', Resolv)
redis:sadd(AVIRA..'owners:'..ChatID,UserID)
...
if redis:sismember(AVIRA..'admins:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'👤¦ العضو » '..USERNAME..' \n🎫¦ الايدي » {'..UserID..'}\n🛠¦ انه بالتأكيد ادمن \n✓️',12,USERCAR) 
end
redis:hset(AVIRA..'username:'..UserID, 'username', Resolv)
redis:sadd(AVIRA..'admins:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'👤¦ العضو » '..USERNAME..' \n🎫¦ الايدي » {'..UserID..'}\n🛠¦ تمت ترقيته ليصبح ادمن \n✓️',12,USERCAR) 
end

if cmd == "remowner" then
if not redis:sismember(AVIRA..'owners:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'👤¦ العضو » '..USERNAME..' \n🎫¦ الايدي » {'..UserID..'}\n🛠¦ انه بالتأكيد ليس مدير \n✓️',12,USERCAR) 
end
redis:srem(AVIRA..'owners:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'👤¦ العضو » '..USERNAME..' \n🎫¦ الايدي » {'..UserID..'}\n🛠¦ تم تنزيله من المدير  \n✓️',12,USERCAR) 
end

if cmd == "demote" then
if not redis:sismember(AVIRA..'admins:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'👤¦ العضو » '..USERNAME..' \n🎫¦ الايدي » {'..UserID..'}\n🛠¦ انه بالتأكيد ليس ادمن \n✓️',12,USERCAR) 
end
redis:srem(AVIRA..'admins:'..ChatID,UserID)
...
if cmd == "active" then
local maseegs = redis:get(AVIRA..'msgs:'..UserID..':'..ChatID) or 1
...
redis:hset(AVIRA..'username:'..UserID, 'username', Resolv)
redis:sadd(AVIRA..'banned:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'👤¦ العضو » '..USERNAME..' \n🎫¦ الايدي » {'..UserID..'}\n🛠¦ تم حظره  \n✓️',12,USERCAR) 
end
end)
...
if cmd == "unban" then
if not redis:sismember(AVIRA..'banned:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'👤¦ العضو » '..USERNAME..' \n🎫¦ الايدي » {'..UserID..'}\n🛠¦ تم بالتأكيد الغاء حظره  \n✓️',12,USERCAR) 
else
return SendMention(ChatID,UserID,MsgID,'👤¦ العضو » '..USERNAME..' \n🎫¦ الايدي » {'..UserID..'}\n🛠¦ تم الغاء حظره \n✓️',12,USERCAR) 
end
redis:srem(AVIRA..'banned:'..ChatID,UserID)
...
if redis:sismember(AVIRA..'is_silent_users:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'👤¦ العضو » '..USERNAME..' \n🎫¦ الايدي » {'..UserID..'}\n🛠¦ تم بالتأكيد كتمه  \n✓️',12,USERCAR) 
end
redis:hset(AVIRA..'username:'..UserID, 'username', Resolv)
redis:sadd(AVIRA..'is_silent_users:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'👤¦ العضو » '..USERNAME..' \n🎫¦ الايدي » {'..UserID..'}\n🛠¦ تم كتمه \n✓️',12,USERCAR) 
end

if cmd == "unsilent" then
if not redis:sismember(AVIRA..'is_silent_users:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'👤¦ العضو » '..USERNAME..' \n🎫¦ الايدي » {'..UserID..'}\n🛠¦ تم بالتاكيد الغاء كتمه  \n✓️',12,USERCAR) 
end
redis:srem(AVIRA..'is_silent_users:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'👤¦ العضو » '..USERNAME..' \n🎫¦ الايدي » {'..UserID..'}\n🛠¦ تم الغاء كتمه  \n✓️',12,USERCAR) 
end
...
redis:hset(AVIRA..'username:'..UserID, 'username',Resolv)
redis:sadd(AVIRA..'gban_users',UserID)
...
redis:srem(AVIRA..'gban_users',UserID)
return SendMention(ChatID,UserID,MsgID,'👤¦ العضو » '..USERNAME..' \n🎫¦ الايدي » {'..UserID..'}\n🛠¦ تم الغاء حظره العام \n✓️',12,USERCAR) 
end
...
if redis:sismember(AVIRA..':SUDO_BOT:',UserID) then 
return SendMention(ChatID,UserID,MsgID,'👤¦ العضو » '..USERNAME..' \n🎫¦ الايدي » {'..UserID..'}\n🛠¦ انه بالتأكيد مطور \n✓️',12,USERCAR) 
end
redis:hset(AVIRA..'username:'..UserID, 'username', Resolv)
redis:sadd(AVIRA..':SUDO_BOT:',UserID)
return SendMention(ChatID,UserID,MsgID,'👤¦ العضو » '..USERNAME..' \n🎫¦ الايدي » {'..UserID..'}\n🛠¦ تم ترقيته ليصبح مطور \n✓️',12,USERCAR) 
end

if cmd == "dn_sudo" then
if not redis:sismember(AVIRA..':SUDO_BOT:',UserID) then 
return SendMention(ChatID,UserID,MsgID,'👤¦ العضو » '..USERNAME..' \n🎫¦ الايدي » {'..UserID..'}\n🛠¦ انه بالتأكيد ليس مطور \n✓️',12,USERCAR) 
end
redis:srem(AVIRA..':SUDO_BOT:',UserID)
...
redis:hset(AVIRA..'username:'..UserID, 'username', UserName)
redis:sadd(AVIRA..':MONSHA_BOT:'..ChatID,UserID)
return sendMsg(ChatID,MsgID,'👤*¦* العضو » '..UserName..' \n🎫*¦* الايدي » (`'..UserID..'`)\n🛠*¦* تمت ترقيته ليصبح منشىء في البوت \n✓️')
end
...
if redis:sismember(AVIRA..'banned:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,'👤*¦* العضو » '..UserName..' \n🎫*¦* الايدي » (`'..UserID..'`)\n🛠*¦* تم بالتأكيد حظره \n✓️') 
end
kick_user(UserID, ChatID,function(arg,data)
if data.ID == "Error" and data.code_ == 400 then
...
Restrict(ChatID,UserID,1)
redis:hset(AVIRA..'username:'..UserID, 'username', Resolv)
redis:sadd(AVIRA..':tqeed:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'👤¦ العضو » '..USERNAME..' \n🎫¦ الايدي » {'..UserID..'}\n🛠¦ تم تقييد آلعضـو بنجآح \n✓️',12,USERCAR) 
end 
if cmd =="fktqeed" then
Restrict(ChatID,UserID,2)
redis:srem(AVIRA..':tqeed:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'👤¦ العضو » '..USERNAME..' \n🎫¦ الايدي » {'..UserID..'}\n🛠¦ تم فگ تقييد آلعضـو بنجآح \n✓️',12,USERCAR) 
end
if cmd == "setwhitelist" then
if redis:sismember(AVIRA..'whitelist:'..ChatID,UserID) then 
...
if cmd == "dn_sudo" then
if not redis:sismember(AVIRA..':SUDO_BOT:',UserID) then return sendMsg(ChatID,MsgID,'👤*¦* العضو » '..USERNAME..' \n🎫*¦* الايدي » (`'..UserID..'`)\n🛠*¦* انه بالتأكيد ليس مطور \n✓') end
redis:srem(AVIRA..':SUDO_BOT:',UserID) 
return SendMention(ChatID,UserID,MsgID,'👤¦ العضو » '..USERNAME..' \n🎫¦ الايدي » {'..UserID..'}\n🛠¦ تم تنزيله من المطورين \n✓️',12,USERCAR) 
end
...
if redis:get(AVIRA..'welcome:get'..msg.chat_id_) then welcomex = "{ مفعل }" else welcomex = "{ معطل }" end
if redis:get(AVIRA..'lock_id'..msg.chat_id_) then lock_idx = "{ مفعل }" else lock_idx = "{ معطل }" end
if redis:get(AVIRA..'replay'..msg.chat_id_)  then replayx  = "{ مفعل }" else replayx  = "{ معطل }" end
if redis:get(AVIRA..'lock_woring'..msg.chat_id_) then lock_woringx = "{ مفعل }" else lock_woringx  = "{ معطل }" end
list_settings = "*👮🏾¦*` اعدادات المجموعه :` \n"
.."\n📝¦ التعديل » "..(redis:get(AVIRA..'lock_edit'..msg.chat_id_) or 'false')
.."\n🔗¦ الروابط » "..(redis:get(AVIRA..'lock_link'..msg.chat_id_) or 'false')
.."\n#️⃣¦ التاك » "..(redis:get(AVIRA..'lock_tag'..msg.chat_id_) or 'false')
.."\n©¦ المعرفات » "..(redis:get(AVIRA..'lock_username'..msg.chat_id_) or 'false')
.."\n\n💱¦ التكرار » "..(redis:get(AVIRA..'lock_flood'..msg.chat_id_) or 'false')
.."\n📑¦ الكلايش » "..(redis:get(AVIRA..'lock_spam'..msg.chat_id_) or 'false')
.."\n🌐¦ الويب » "..(redis:get(AVIRA..'lock_webpage'..msg.chat_id_) or 'false')
.."\n⚜️¦ الماركدوان » "..(redis:get(AVIRA..'lock_markdown'..msg.chat_id_) or 'false')
.."\n🏌🏻¦ البوتات بالطرد » "..(redis:get(AVIRA..'lock_bots_by_kick'..msg.chat_id_) or 'false')
.."\n🤖¦ البوتات » "..(redis:get(AVIRA..'lock_bots'..msg.chat_id_) or 'false')
.."\n➕¦ عدد التكرار » "..(redis:get(AVIRA..'num_msg_max'..msg.chat_id_) or 'false')
.."\n\n🎬¦` اعدادات الوسائط :`\n"
.."\n*¦* المتحركه » "..(redis:get(AVIRA..'mute_gif'..msg.chat_id_) or 'false')
.."\n💭¦ الدردشه » "..(redis:get(AVIRA..'mute_text'..msg.chat_id_) or 'false')
.."\n◽️¦ الانلاين » "..(redis:get(AVIRA..'mute_inline'..msg.chat_id_) or 'false')
.."\n🎮¦ الالعاب » "..(redis:get(AVIRA..'mute_game'..msg.chat_id_) or 'false')
.."\n🏞¦ الصور » "..(redis:get(AVIRA..'mute_photo'..msg.chat_id_) or 'false')
.."\n🎥¦ الفيديو » "..(redis:get(AVIRA..'mute_video'..msg.chat_id_) or 'false')
.."\n🎙¦ البصمات » "..(redis:get(AVIRA..'mute_audio'..msg.chat_id_) or 'false')
.."\n\n🔉¦ الصوت » "..(redis:get(AVIRA..'mute_voice'..msg.chat_id_) or 'false')
.."\n🎎¦ الملصقات » "..(redis:get(AVIRA..'mute_sticker'..msg.chat_id_) or 'false')
.."\n📞¦ الجهات » "..(redis:get(AVIRA..'mute_contact'..msg.chat_id_) or 'false')
.."\n💱¦ التوجيه » "..(redis:get(AVIRA..'mute_forward'..msg.chat_id_) or 'false')
.."\n🌐¦ الموقع » "..(redis:get(AVIRA..'mute_location'..msg.chat_id_) or 'false')
.."\n🗂¦ الملفات » "..(redis:get(AVIRA..'mute_document'..msg.chat_id_) or 'false')
.."\n🔅¦ الاشعارات » "..(redis:get(AVIRA..'mute_tgservice'..msg.chat_id_) or 'false')
.."\n🔒¦ الكيبورد » "..(redis:get(AVIRA..'mute_keyboard'..msg.chat_id_) or 'false')
.."\n\n*⚒¦*` اعدادات اخرى : `"
.."\n*🙋🏼‍♂️¦* الترحيب » "..welcomex
.."\n*💬¦*  الردود » "..replayx
...
.."\n*➕¦* عدد التكرار » "..(redis:get(AVIRA..'num_msg_max'..msg.chat_id_) or 'false')
.."\n\n*💱¦*` اعدادات التقـييد :`\n"
.."\n*💢¦* التقييد بالتوجيه » "..(redis:get(AVIRA..':tqeed_fwd:'..msg.chat_id_) or 'false')
.."\n*📸¦* التقييد بالصور » "..(redis:get(AVIRA..':tqeed_photo:'..msg.chat_id_) or 'false')
.."\n*🔗¦* التقييد بالروابط » "..(redis:get(AVIRA..':tqeed_link:'..msg.chat_id_) or 'false')
.."\n*🎉¦* التقييد بالمتحركه » "..(redis:get(AVIRA..':tqeed_gif:'..msg.chat_id_) or 'false')
.."\n*🎥¦* التقييد الفيديو » "..(redis:get(AVIRA..':tqeed_video:'..msg.chat_id_) or 'false')
list_settings = list_settings:gsub('true', '{ مقفول }')
list_settings = list_settings:gsub('false', '{ مفتوح }')

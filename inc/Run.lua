...
#      ███    ██▄ ███    ███          ███          ███ ¦ Dev : @ABDURHMAN
#      ███    ███ ███    ███    ▄█    ███    ▄█    ███
#    ▄█████████▀   ▀██████▀   ▄████████▀   ▄████████▀  ¦ Source TH3AVIRA BY @AVIRASOURCE
#---------------------------------------------------------------------
]] 
...
local url , res = https.request('https://api.AVIRASOURCE.com/GetUser/?User='..SUDO_USER)
if res ~= 200 then
...
AVIRA = Token:match("(%d+)")
redis:set(AVIRA..":VERSION",GetUser.information.Source_version)
redis:set(AVIRA..":SUDO_ID:",GetUser.information.id)
redis:set(AVIRA..":DataCenter:",GetUser.information.DataCenter)
redis:set(AVIRA..":UserNameBot:",BOT_User)
redis:set(AVIRA..":NameBot:",BOT_NAME)
redis:hset(AVIRA..'username:'..GetUser.information.id,'username','@'..GetUser.information.username:gsub('_',[[\_]]))
